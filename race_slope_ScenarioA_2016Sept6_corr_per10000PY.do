...
scalar p_death45_exp1 = r(mean)
summarize death45 if (exposure==0), meanonly
scalar p_death45_exp0 = r(mean)

summarize death50, meanonly
scalar p_death50 = r(mean)
summarize death50 if (exposure==1), meanonly
scalar p_death50_exp1 = r(mean)
summarize death50 if (exposure==0), meanonly
scalar p_death50_exp0 = r(mean)

summarize death55, meanonly
scalar p_death55 = r(mean)
summarize death55 if (exposure==1), meanonly
scalar p_death55_exp1 = r(mean)
summarize death55 if (exposure==0), meanonly
scalar p_death55_exp0 = r(mean)

summarize death60, meanonly
scalar p_death60 = r(mean)
summarize death60 if (exposure==1), meanonly
scalar p_death60_exp1 = r(mean)
summarize death60 if (exposure==0), meanonly
scalar p_death60_exp0 = r(mean)

summarize death65, meanonly
scalar p_death65 = r(mean)
summarize death65 if (exposure==1), meanonly
scalar p_death65_exp1 = r(mean)
summarize death65 if (exposure==0), meanonly
scalar p_death65_exp0 = r(mean)

summarize death70, meanonly
scalar p_death70 = r(mean)
summarize death70 if (exposure==1), meanonly
scalar p_death70_exp1 = r(mean)
summarize death70 if (exposure==0), meanonly
scalar p_death70_exp0 = r(mean)

summarize death75, meanonly
scalar p_death75 = r(mean)
summarize death75 if (exposure==1), meanonly
scalar p_death75_exp1 = r(mean)
summarize death75 if (exposure==0), meanonly
scalar p_death75_exp0 = r(mean)

summarize death80, meanonly
scalar p_death80 = r(mean)
summarize death80 if (exposure==1), meanonly
scalar p_death80_exp1 = r(mean)
summarize death80 if (exposure==0), meanonly
scalar p_death80_exp0 = r(mean)

summarize death85, meanonly
scalar p_death85 = r(mean)
summarize death85 if (exposure==1), meanonly
scalar p_death85_exp1 = r(mean)
summarize death85 if (exposure==0), meanonly
scalar p_death85_exp0 = r(mean)

summarize death90, meanonly
scalar p_death90 = r(mean)
summarize death90 if (exposure==1), meanonly
scalar p_death90_exp1 = r(mean)
summarize death90 if (exposure==0), meanonly
scalar p_death90_exp0 = r(mean)

summarize death95, meanonly
scalar p_death95 = r(mean)
...
scalar Natrisk45_exp1= r(N)
qui sum U if (exposure==0 & strokeage !=. & strokeage>=45)
scalar meanUatrisk45_exp0= r(mean)
scalar Natrisk45_exp0= r(N)
*age 50
qui sum U if (exposure==1 & strokeage !=. & strokeage>=50)
scalar meanUatrisk50_exp1= r(mean)
scalar Natrisk50_exp1= r(N)
qui sum U if (exposure==0 & strokeage !=. & strokeage>=50)
scalar meanUatrisk50_exp0= r(mean)
scalar Natrisk50_exp0= r(N)
*age 55
qui sum U if (exposure==1 & strokeage !=. & strokeage>=55)
scalar meanUatrisk55_exp1= r(mean)
scalar Natrisk55_exp1= r(N)
qui sum U if (exposure==0 & strokeage !=. & strokeage>=55)
scalar meanUatrisk55_exp0= r(mean)
scalar Natrisk55_exp0= r(N)
*age 60
qui sum U if (exposure==1 & strokeage !=. & strokeage>=60)
scalar meanUatrisk60_exp1= r(mean)
scalar Natrisk60_exp1= r(N)
qui sum U if (exposure==0 & strokeage !=. & strokeage>=60)
scalar meanUatrisk60_exp0= r(mean)
scalar Natrisk60_exp0= r(N)
*age 65
qui sum U if (exposure==1 & strokeage !=. & strokeage>=65)
scalar meanUatrisk65_exp1= r(mean)
scalar Natrisk65_exp1= r(N)
qui sum U if (exposure==0 & strokeage !=. & strokeage>=65)
scalar meanUatrisk65_exp0= r(mean)
scalar Natrisk65_exp0= r(N)
*age 70
qui sum U if (exposure==1 & strokeage !=. & strokeage>=70)
scalar meanUatrisk70_exp1= r(mean)
scalar Natrisk70_exp1= r(N)
qui sum U if (exposure==0 & strokeage !=. & strokeage>=70)
scalar meanUatrisk70_exp0= r(mean)
scalar Natrisk70_exp0= r(N)
*age 75
qui sum U if (exposure==1 & strokeage !=. & strokeage>=75)
scalar meanUatrisk75_exp1= r(mean)
scalar Natrisk75_exp1= r(N)
qui sum U if (exposure==0 & strokeage !=. & strokeage>=75)
scalar meanUatrisk75_exp0= r(mean)
scalar Natrisk75_exp0= r(N)
*age 80
qui sum U if (exposure==1 & strokeage !=. & strokeage>=80)
scalar meanUatrisk80_exp1= r(mean)
scalar Natrisk80_exp1= r(N)
qui sum U if (exposure==0 & strokeage !=. & strokeage>=80)
scalar meanUatrisk80_exp0= r(mean)
scalar Natrisk80_exp0= r(N)
*age 85
qui sum U if (exposure==1 & strokeage !=. & strokeage>=85)
scalar meanUatrisk85_exp1= r(mean)
scalar Natrisk85_exp1= r(N)
qui sum U if (exposure==0 & strokeage !=. & strokeage>=85)
scalar meanUatrisk85_exp0= r(mean)
scalar Natrisk85_exp0= r(N)
*age 90
qui sum U if (exposure==1 & strokeage !=. & strokeage>=90)
scalar meanUatrisk90_exp1= r(mean)
...
foreach x in 45to55 55to65 65to75 75to85 85to95 {
	...
	*scalar strokeln(IRR)`x'_SE = sqrt((1/nstrokes`x'_exp1)+(1/nstrokes`x'_exp0)) //this isn't what I want--I want SE(IRR). also the code i wrote isn't working
...
*stroke IR for blacks
qui stptime if (exposure==1), title(person-years) per(10000)
scalar nstrokes45to55_exp1 = r(failures)
scalar ptime45to55_exp1 = r(ptime)
scalar strokerate10000pys45to55_exp1 = r(rate)
*stroke IR for whites
qui stptime if (exposure==0), title(person-years) per(10000)
scalar nstrokes45to55_exp0 = r(failures)
scalar ptime45to55_exp0 = r(ptime)
scalar strokerate10000pys45to55_exp0 = r(rate)
*stroke IRR and IRD for blacks vs. whites
qui stir exposure
...
*stroke IR for blacks
qui stptime if (exposure==1), title(person-years) per(10000)
scalar nstrokes55to65_exp1 = r(failures)
scalar ptime55to65_exp1 = r(ptime)
scalar strokerate10000pys55to65_exp1 = r(rate)
*stroke IR for whites
qui stptime if (exposure==0), title(person-years) per(10000)
scalar nstrokes55to65_exp0 = r(failures)
scalar ptime55to65_exp0 = r(ptime)
scalar strokerate10000pys55to65_exp0 = r(rate)
*stroke IRR and IRD for blacks vs. whites
qui stir exposure
scalar strokeIRR55to65 = r(irr)
scalar strokeIRR55to65_ub = r(ub_irr)
scalar strokeIRR55to65_lb = r(lb_irr)
scalar strokeIRD55to65 = r(ird)*10000
scalar strokeIRD55to65_ub = r(ub_ird)*10000
scalar strokeIRD55to65_lb = r(lb_ird)*10000

*age 65 to 75
qui stset strokeage, failure(stroke65to75==1) id(id) enter(strokeage65to75_start) exit(strokeage65to75_end)
*stroke IR for blacks
qui stptime if (exposure==1), title(person-years) per(10000)
scalar nstrokes65to75_exp1 = r(failures)
scalar ptime65to75_exp1 = r(ptime)
scalar strokerate10000pys65to75_exp1 = r(rate)
*stroke IR for whites
qui stptime if (exposure==0), title(person-years) per(10000)
scalar nstrokes65to75_exp0 = r(failures)
scalar ptime65to75_exp0 = r(ptime)
scalar strokerate10000pys65to75_exp0 = r(rate)
*stroke IRR and IRD for blacks vs. whites
qui stir exposure
scalar strokeIRR65to75 = r(irr)
scalar strokeIRR65to75_ub = r(ub_irr)
scalar strokeIRR65to75_lb = r(lb_irr)
scalar strokeIRD65to75 = r(ird)*10000
scalar strokeIRD65to75_ub = r(ub_ird)*10000
scalar strokeIRD65to75_lb = r(lb_ird)*10000

*age 75 to 85
qui stset strokeage, failure(stroke75to85==1) id(id) enter(strokeage75to85_start) exit(strokeage75to85_end)
*stroke IR for blacks
qui stptime if (exposure==1), title(person-years) per(10000)
scalar nstrokes75to85_exp1 = r(failures)
scalar ptime75to85_exp1 = r(ptime)
scalar strokerate10000pys75to85_exp1 = r(rate)
*stroke IR for whites
qui stptime if (exposure==0), title(person-years) per(10000)
scalar nstrokes75to85_exp0 = r(failures)
scalar ptime75to85_exp0 = r(ptime)
scalar strokerate10000pys75to85_exp0 = r(rate)
*stroke IRR and IRD for blacks vs. whites
qui stir exposure
scalar strokeIRR75to85 = r(irr)
scalar strokeIRR75to85_ub = r(ub_irr)
scalar strokeIRR75to85_lb = r(lb_irr)
scalar strokeIRD75to85 = r(ird)*10000
scalar strokeIRD75to85_ub = r(ub_ird)*10000
scalar strokeIRD75to85_lb = r(lb_ird)*10000

*age 85 to 95
qui stset strokeage, failure(stroke85to95==1) id(id) enter(strokeage85to95_start) exit(strokeage85to95_end)
*stroke IR for blacks
qui stptime if (exposure==1), title(person-years) per(10000)
scalar nstrokes85to95_exp1 = r(failures)
scalar ptime85to95_exp1 = r(ptime)
scalar strokerate10000pys85to95_exp1 = r(rate)
*stroke IR for whites
qui stptime if (exposure==0), title(person-years) per(10000)
scalar nstrokes85to95_exp0 = r(failures)
scalar ptime85to95_exp0 = r(ptime)
scalar strokerate10000pys85to95_exp0 = r(rate)
*stroke IRR and IRD for blacks vs. whites
qui stir exposure
scalar strokeIRR85to95 = r(irr)
scalar strokeIRR85to95_ub = r(ub_irr)
...
scalar nstrokes50to55_exp0 = r(mean)*r(N)
sum stroke55to60 if exposure==0
scalar nstrokes55to60_exp0 = r(mean)*r(N)
sum stroke60to65 if exposure==0
scalar nstrokes60to65_exp0 = r(mean)*r(N)
sum stroke65to70 if exposure==0
scalar nstrokes65to70_exp0 = r(mean)*r(N)
sum stroke70to75 if exposure==0
scalar nstrokes70to75_exp0 = r(mean)*r(N)
sum stroke75to80 if exposure==0
scalar nstrokes75to80_exp0 = r(mean)*r(N)
sum stroke80to85 if exposure==0
scalar nstrokes80to85_exp0 = r(mean)*r(N)
sum stroke85to90 if exposure==0
scalar nstrokes85to90_exp0 = r(mean)*r(N)
sum stroke90to95 if exposure==0
scalar nstrokes90to95_exp0 = r(mean)*r(N)

sum stroke45to50 if exposure==1
scalar nstrokes45to50_exp1 = r(mean)*r(N)
sum stroke50to55 if exposure==1
scalar nstrokes50to55_exp1 = r(mean)*r(N)
sum stroke55to60 if exposure==1
scalar nstrokes55to60_exp1 = r(mean)*r(N)
sum stroke60to65 if exposure==1
scalar nstrokes60to65_exp1 = r(mean)*r(N)
sum stroke65to70 if exposure==1
scalar nstrokes65to70_exp1 = r(mean)*r(N)
sum stroke70to75 if exposure==1
scalar nstrokes70to75_exp1 = r(mean)*r(N)
sum stroke75to80 if exposure==1
scalar nstrokes75to80_exp1 = r(mean)*r(N)
sum stroke80to85 if exposure==1
scalar nstrokes80to85_exp1 = r(mean)*r(N)
